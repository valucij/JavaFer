 ...
 *  This class uses thread pool for computing data.
 *  
...
public class RayCasterParallel {
	...
	public static class RayCasterJob extends RecursiveAction{
		...
		private int yMin;
		/**
		 * Number of max direct computes
		 */
		private final int MAX_NUMBER_COMPUTING = 50;
		/**
		 * Constructor
		 * @param eye ray from user eye
		 * @param view ray from scene
		 * @param viewUp ray that help determine j vector
		 * @param horizontal i vector
		 * @param vertical j vector
		 * @param width width of scene
		 * @param height height of scene
		 * @param requestNo long
		 * @param red red color
		 * @param blue blue color
		 * @param green green color
		 * @param cancel atomic boolean
