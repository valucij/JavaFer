 ...
 */
	private static class ListNode{
		...
		ListNode previous;
		/**
		 * Value of a element in this ListNode
		 */
		Object value;
	}
	/**
	...
	private int size;
	/**
	 * Reference to first ListNode in collection
	 */
	private ListNode first;
	/**
	 * Reference to last ListNode in collection
	 */
 ...
 */
	...
	public ListElementsGetter createElementsGetter() {
		...
		ListElementsGetter newgetter = new ListElementsGetter(this);
		return newgetter;
	}
 ...
 */
	private static class ListElementsGetter implements ElementsGetter{
		...
		/**
		 * ListNode that is a reference to first node in this collection
		 * so it can help us while going through the collection
		 */
		 ...
		 */
		private LinkedListIndexedCollection helpCol;
		/**
		...
		private int index;
		/**
		 * Helps us keep track on size of collection
		 */
 ...
 */
		ListElementsGetter(LinkedListIndexedCollection col){
			node = col.first;
			helpCol = col;
			index = 0;
			helpsize = col.size();
