 ...
 *
 */
@WebServlet(name="glxls", urlPatterns={"/servleti/glasanje-xls"})
public class GlasanjeXLSServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Map<String, String> bandNames = GlasanjeUtil.returnMapIdAndBandName(pollID);
		Map<String, String> results = GlasanjeUtil.returnMapResults(pollID);
